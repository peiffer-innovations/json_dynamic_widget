...
* **Code Generation**: A code generator is now in place to be able to create auto-bindings from widgets to the JSON data.  More details to come with the official 7.0.0 release.
