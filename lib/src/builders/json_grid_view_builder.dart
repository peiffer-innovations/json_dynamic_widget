...
class JsonGridViewBuilder extends JsonWidgetBuilder {
  ...
  SliverGridDelegate _decodeGridDelegate(double maxWidth) {
...
a delegate arg that follows one of the two structures:''');
    ...
    if (result == null) {
      if (maxWidth.isInfinite) {
        throw createException('''
[grid_builder]: Cannot build grid with an unknown width and an unknown item 
count.  To resolve this add a delegate arg that follows one of the two 
structures:''');
      }
      result = SliverGridDelegateWithMaxCrossAxisExtent(
  ...
  Widget buildCustom({
    ...
    return LayoutBuilder(
      builder: (context, constraints) => GridView.builder(
        ...
        dragStartBehavior: dragStartBehavior,
        gridDelegate: _decodeGridDelegate(constraints.maxWidth),
