  ...
  static InputDecoration fromDynamic(
    ...
    if (map != null) {
      result = InputDecoration(
        ...
        border: ThemeDecoder.decodeInputBorder(map['border']),
        ...
        counterStyle: ThemeDecoder.decodeTextStyle(map['counterStyle']),
        counterText: map['counterText'],
        disabledBorder: ThemeDecoder.decodeInputBorder(map['disabledBorder']),
        enabled:
            map['enabled'] == null ? true : JsonClass.parseBool(map['enabled']),
        enabledBorder: ThemeDecoder.decodeInputBorder(map['enabledBorder']),
        errorBorder: ThemeDecoder.decodeInputBorder(map['errorBorder']),
        errorMaxLines: JsonClass.parseInt(map['errorMaxLines']),
        errorStyle: ThemeDecoder.decodeTextStyle(map['errorStyle']),
        errorText: map['errorText'],
        fillColor: ThemeDecoder.decodeColor(map['fillColor']),
        filled:
        ...
        focusedBorder: ThemeDecoder.decodeInputBorder(map['focusedBorder']),
        focusedErrorBorder:
            ThemeDecoder.decodeInputBorder(map['focusedErrorBorder']),
        helperMaxLines: JsonClass.parseInt(map['helperMaxLines']),
        helperStyle: ThemeDecoder.decodeTextStyle(map['helperStyle']),
        helperText: map['helperText'],
        hintMaxLines: JsonClass.parseInt(map['hintMaxLines']),
        hintStyle: ThemeDecoder.decodeTextStyle(map['hintStyle']),
        ...
        isDense:
            map['isDence'] == null ? null : JsonClass.parseBool(map['isDense']),
        labelStyle: ThemeDecoder.decodeTextStyle(map['labelStype']),
        ...
        prefixStyle: ThemeDecoder.decodeTextStyle(map['prefixStyle']),
        ...
        suffixStyle: ThemeDecoder.decodeTextStyle(map['suffixStyle']),
