...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _8494: x0 => x0.headers,
      _8495: x0 => x0.body,
      _12868: () => globalThis.document,
      _12888: x0 => x0.src,
      _12889: (x0,x1) => x0.src = x1,
      _12890: x0 => x0.naturalWidth,
      _12891: x0 => x0.naturalHeight,
      _12907: x0 => x0.status,
      _12908: (x0,x1) => x0.responseType = x1,
      _12910: x0 => x0.response,
...
"ease_in_expo_curve",
"ease_in_out_curve",
"ease_in_out_back_curve",
"ease_in_out_circ_curve",
"ease_in_out_cubic_curve",
"ease_in_out_expo_curve",
"ease_in_out_quad_curve",
"ease_in_out_quart_curve",
"ease_in_out_quint_curve",
"ease_in_out_sine_curve",
"ease_in_quad_curve",
"ease_in_quart_curve",
"ease_in_quint_curve",
"ease_in_sine_curve",
"ease_in_to_linear_curve",
"ease_out_curve",
"ease_out_back_curve",
"ease_out_circ_curve",
"ease_out_cubic_curve",
"ease_out_expo_curve",
"ease_out_quad_curve",
"ease_out_quart_curve",
"ease_out_quint_curve",
"ease_out_sine_curve",
"elastic_in_curve",
"elastic_in_out_curve",
"elastic_out_curve",
"fast_linear_to_slow_ease_in_curve",
"fast_out_slow_in_curve",
"linear_curve",
"linear_to_ease_out_curve",
"slow_middle_curve",
"constraints",
"decoration",
"enableFeedback",
...
"disabled",
"WidgetState.",
"Unknown type of EdgeInsets detected: [",
"maxHeight",
"maxWidth",
"minHeight",
"minWidth",
...
"stadium",
"IconAlignment.",
"Unknown type of AlignmentGeometry encountered: ",
"bottomCenter",
"centerLeft",
"centerRight",
"topCenter",
...
"page",
"rangeMaintaining",
"Unknown ScrollPhysics class encounted: ",
"parent",
"enforced",
...
"rrect",
"example",
"Unable to find JsonWidgetData via [",
"] on the registry",
"EQ==",
"*** WIDGET PARSE ERROR ***\n",
"SEVERE",
...
"SHOUT",
"WARNING",
"[length]: Missing required first arg",
"[length]: Unknown type: ",
"for_each",
"${",
"for_each_",
...
"delay",
"delayed",
"[delayed]: expected [value] to be a Duration, a String, or a num but encountered: ",
"Non-nullable parseDouble was called but null was encountered",
"[delay]: expected [value] to be a Duration, a String, or a num but encountered: ",
"[await]: expected [value] to be a Future but encountered: ",
"AES",
"IV",
"RSA",
"Unknown IV type: [",
...
"minutes",
"seconds",
"[Duration]: expected [value] to be a Map, a List, a String, or a num but encountered: ",
"DateFormat",
"DateTime",
"now",
"year",
...
"minute",
"second",
"[DateTime]: expected [value] to be a Map, a List, a num, a String, or null but encountered: ",
"yyyy-MM-dd",
"ccc",
"EEEE",
"cccc",
...
"[JsonWidgetData] An unsupported type was passed in to \"maybeFromDynamic\": ",
"Kg==",
"Kw==",
...
"Found given encoder for object: [",
"Unable to encode object: [",
"${null}",
"JsonWidgetExporterData",
"yaml",
"|-",
"singleQuote",
"doubleQuote",
...
"JsonWidgetStateProperty({",
"Unable to decode required Color for WidgetStateColor for state: ",
" and no \"empty\" value exists.",
"allowedInteraction",
"noThumb",
"slideOnly",
"slideThumb",
...
"[RequiredValidator.fromDynamic]: map is null",
...
"{label} must be at most {number}",
"form_validation_min_length",
"{label} must contain at least {length} characters",
"form_validation_min_number",
"{label} must be at least {number}",
"form_validation_number",
"form_validation_number_decimal",
"form_validation_phone_number",
"{label} is required",
"[PhoneNumberValidator.fromDynamic]: map is null",
"^\\s*(?:\\+?(\\d{1,3}))?[-. (]*(\\d{3})[-. )]*(\\d{3})[-. ]*(\\d{4})(?: *x(\\d+))?\\s*$",
"[NumberValidator.fromDynamic]: map is null",
"[MinNumberValidator.fromDynamic]: map is null",
"[MinLengthValidator.fromDynamic]: map is null",
"[MaxNumberValidator.fromDynamic]: map is null",
"[MaxLengthValidator.fromDynamic]: map is null",
"[EmailValidator.fromDynamic]: map is null",
"^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,253}[a-zA-Z0-9])?(?:\\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,253}[a-zA-Z0-9])?)*$",
"[CurrencyValidator.fromDynamic]: map is null",
"Invalid Number: ",
"Invalid number: ",
"result",
...
"mainAxisSpacing",
"crossAxisCount",
"[grid_builder]: Unknown delegate type encountered: [",
...
"Second",
"Third",
"This is a simple print message",
"customSize",
"customTextStyle",
"form_validation",
